...
class ImplicitRecommender:
    """This class computes recommendations for a given user using the implicit library"""

    def __init__(self, artist_retriever: ArtistRetriever, implicit_model: implicit.recommender_base.RecommenderBase) -> None:
